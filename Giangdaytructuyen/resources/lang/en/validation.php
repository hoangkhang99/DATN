...
return [
    ...
    */
    ...
    'between'              => [
        'numeric' => 'Thuộc tính: phải nằm giữa :min and :max.',
        'file'    => 'Thuộc tính: phải nằm giữa :min and :max kilobytes.',
        'string'  => 'Thuộc tính: phải nằm giữa :min and :max characters.',
        'array'   => 'Thuộc tính: phải có giữa :min and :max items.',
    ],
